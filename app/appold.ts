...
import { BarTooltip } from './behavior/barTooltip'
import { PieTooltip } from './behavior/pieTooltip'
...
export function main(el: HTMLElement): void {
    ...
    document.getElementById('col').addEventListener('click', (ev) => {
        ...
        chart.tooltip = new BarTooltip(true, xScale,false)
        chart.draw(data)
    })
    ...
    document.getElementById('bar').addEventListener('click', (ev) => {
		...
		column1.dataLabels = new DataLabel()
		column2.dataLabels = new DataLabel()
        chart.tooltip = new BarTooltip(true, yScale, true)
        chart.draw(data)
    })
    ...
    document.getElementById('pie').addEventListener('click', (ev) => {
        ...
        chart.tooltip = new PieTooltip(false,xScale,false)
        chart.draw(data)
    })
