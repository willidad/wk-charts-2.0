...
System.registerDynamic("npm:d3@3.5.6/d3.js", [], false, function(__require, __exports, __module) {
...
var __moduleName = "file:///app/tools/drawing.ts";
System.register("app/tools/drawing.ts", [], function(exports_1) {
  function measureLabel(text, container, labelStyle, bgStyle) {
  ...
  exports_1("measureLabel", measureLabel);
  function drawLabel(text, container, labelStyle, bgStyle) {
...
var __moduleName = "file:///app/core/defaults.ts";
System.register("app/core/defaults.ts", [], function(exports_1) {
  var emptyStyle,
      chart,
      grid,
      axis,
  ...
  return {
    ...
    execute: function() {
      ...
      exports_1("grid", grid = {lineStyle: {stroke: 'lightgrey'}});
      exports_1("axis", axis = {
      ...
      exports_1("line", line = {lineStyle: emptyStyle});
      exports_1("area", area = {areaStyle: {opacity: 0.5}});
      exports_1("column", column = {columnStyle: emptyStyle});
      exports_1("pie", pie = {pieStyle: {opacity: 0.4}});
      exports_1("markers", markers = {
        markerStyle: emptyStyle,
        markerSize: 5
      });
      exports_1("dataLabels", dataLabels = {
      ...
      exports_1("duration", duration = 1000);
    }
  };
});
    ...
    execute: function() {
      Grid = (function() {
        function Grid(axis) {
          var _this = this;
          this._lineStyle = {};
          this.draw = function(container, ranges, animate) {
            var ticks = container.selectAll(".wk-chart-axis.wk-chart-" + axis_1.Position[_this._axis.orientation] + " > .tick");
            ticks.each(_this.addGridLine(ranges));
          };
          this._axis = axis;
        }
        Object.defineProperty(Grid.prototype, "lineStyle", {
          get: function() {
            return _.defaults(this._lineStyle, defaults_1.grid.lineStyle);
          },
          set: function(val) {
            this._lineStyle = val;
          },
        ...
        Grid.prototype.addGridLine = function(ranges) {
          var _self = this;
          ...
          return function(d) {
            ...
            switch (orient) {
              case axis_1.Position.left:
                gridLine.attr('x1', ranges.x[0]).attr('x2', ranges.x[1]);
                break;
              case axis_1.Position.right:
                gridLine.attr('x1', -ranges.x[0]).attr('x2', -ranges.x[1]);
                break;
              case axis_1.Position.top:
                gridLine.attr('y1', ranges.y[0]).attr('y2', ranges.y[1]);
                break;
              case axis_1.Position.bottom:
                gridLine.attr('y1', -ranges.y[0]).attr('y2', -ranges.y[1]);
                break;
            }
...
var __moduleName = "file:///app/tools/resizeSensor.ts";
System.register("app/tools/resizeSensor.ts", [], function(exports_1) {
  var ResizeSensor;
  return {
    setters: [],
    execute: function() {
      ResizeSensor = (function() {
        function ResizeSensor(element, callback) {
          ...
          function attachResizeEvent(element, resized) {
            ...
            element.resizeSensor.innerHTML = '<div class="wk-chart-resize-sensor-expand" style="' + style + '">' + '<div style="' + styleChild + '"></div>' + '</div>' + '<div class="wk-chart-resize-sensor-shrink" style="' + style + '">' + '<div style="' + styleChild + ' width: 200%; height: 200%"></div>' + '</div>';
      ...
      exports_1("ResizeSensor", ResizeSensor);
    }
  };
});

var __moduleName = "file:///app/tools/innerSVG.ts";
System.register("app/tools/innerSVG.ts", [], function(exports_1) {
  return {
    setters: [],
    execute: function() {
      (function() {
...
var __moduleName = "file:///app/tools/data-table.ts";
System.register("app/tools/data-table.ts", ["npm:d3@3.5.6.js", "npm:lodash@3.10.0.js"], function(exports_1) {
  var d3,
      _;
  var DataTable;
  return {
    ...
    execute: function() {
      DataTable = (function() {
        function DataTable(container, initialData, change) {
          var _this = this;
          ...
          this.setData = function(data) {
            var rows = _this.table.selectAll('.row').data(data, function(d) {
              return d['x'];
            });
            rows.enter().append('tr').attr('class', 'row');
            var cols = rows.selectAll('.col').data(function(d, i) {
              return _this.entries(d, i);
            }, function(d) {
              return d['key'];
            });
            ...
            cols.select('input').attr('value', function(d) {
              this.value = d.value;
              return d.value;
            }).on('change', _this.changeHandler());
            var check = rows.select('.check');
            if (check.empty()) {
              rows.append('input').attr('class', 'check').attr('type', 'checkbox').attr('checked', true).on('change', _this.checkHandler());
            }
            cols.exit().remove();
            rows.exit().remove();
          };
        ...
        DataTable.prototype.changeHandler = function() {
          var _self = this;
          return function(d, i) {
        ...
        DataTable.prototype.checkHandler = function() {
          var _self = this;
          return function(d, i) {
        ...
        DataTable.prototype.btnClick = function() {
          var _self = this;
          return function(ev) {
        ...
        DataTable.prototype.entries = function(row, i) {
          var res = [];
          for (var key in row) {
            res.push({
              key: key,
...
System.registerDynamic("npm:d3@3.5.6.js", ["npm:d3@3.5.6/d3.js"], true, function(require, exports, module) {
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = require("npm:d3@3.5.6/d3.js");
  global.define = __define;
  return module.exports;
});
...
var __moduleName = "file:///app/core/axis.ts";
System.register("app/core/axis.ts", ["npm:d3@3.5.6.js", "npm:lodash@3.10.0.js", "app/tools/drawing.ts", "app/core/defaults.ts"], function(exports_1) {
  var d3,
      _,
      drawing,
      defaults_1;
  ...
  return {
    ...
    execute: function() {
      ...
      Axis = (function() {
        function Axis(orientation, scale, title) {
          var _this = this;
          this.title = title;
          this._d3Axis = d3.svg.axis();
          this._titleStyle = {};
          this._titleBgStyle = {};
          this._tickLabelStyle = {};
          this._tickLabelBgStyle = {};
          this._tickLineStyle = {};
          this.getRotation = function(degree) {
            return [("rotate(" + -degree + ", 0, -10)"), ("rotate(" + degree + ", 0, 10)"), ("rotate(" + degree + ", -10, 0)"), ("rotate(" + degree + ", 10, 0)")][_this._orient];
          };
          this.getAnchor = function(orient, rotation) {
            if (rotation === 0)
              return ['middle', 'middle', 'end', 'start'][orient];
            if (rotation > 0 && rotation < 90)
              return ['start', 'start', 'end', 'start'][orient];
            if (rotation === 90)
              return ['start', 'start', 'middle', 'middle'][orient];
            if (rotation > 90 && rotation < 180)
              return ['start', 'start', 'start', 'end'][orient];
            if (rotation === 180)
              return ['middle', 'middle', 'start', 'end'][orient];
            if (rotation > -90)
              return ['end', 'end', 'end', 'start'][orient];
            if (rotation === -90)
              return ['end', 'end', 'middle', 'middle'][orient];
            if (rotation < 90 && rotation > -180)
              return ['end', 'end', 'start', 'end'][orient];
            if (rotation === -180)
              return ['middle', 'middle', 'start', 'end'][orient];
          };
          this.getDY = function(orient, rotation) {
            if (rotation === 0)
              return [null, '0.71em', '0.35em', '0.35em'][orient];
            if (Math.abs(rotation) === 180)
              return ['0.71em', null, '0.35em', '0.35em'][orient];
            if (rotation === 90)
              return ['0.35em', '0.35em', '0.71em', null][orient];
            if (rotation === -90)
              return ['0.35em', '0.35em', null, '0.71em'][orient];
            return '0.35em';
          };
          this.tickRotation = 0;
          this.getNeededSpace = function(ctnr, data) {
            _this._d3Axis.scale(_this._scale.getD3Scale()).orient(Position[_this._orient]);
            _this._scale.setDomain(data);
            _this._scale.setRange([0, 100]);
            var drawTo = d3.select(".wk-chart-axis.wk-chart-" + Position[_this._orient]);
            if (drawTo.empty()) {
              drawTo = ctnr.insert('g', '.wk-chart-layout-area').attr('class', "wk-chart-axis wk-chart-" + Position[_this._orient]);
            }
            var measuredDrawTo = drawTo.append('g');
            measuredDrawTo.call(_this._d3Axis);
            var ticks = measuredDrawTo.selectAll('.tick > text').attr('transform', _this.getRotation(_this.tickRotation)).style('text-anchor', _this.getAnchor(_this._orient, _this.tickRotation)).attr('dy', _this.getDY(_this._orient, _this.tickRotation));
            _this._requiredSpace = _this.isVertical ? measuredDrawTo.node().getBBox().width : measuredDrawTo.node().getBBox().height;
            _this._requiredSpace += _this._titleHeight = _this.title ? drawing.measureLabel(_this.title, measuredDrawTo, _this.titleStyle, _this.titleBgStyle).height : 0;
            measuredDrawTo.remove();
            return _this._requiredSpace;
          };
          this.draw = function(ctnr, data, layoutSize, ranges, animate) {
            var d3Scale = _this._scale.getD3Scale();
            _this._d3Axis.scale(d3Scale).orient(Position[_this._orient]);
            _this._scale.setDomain(data);
            _this._scale.setRange(_this.isVertical ? ranges.y : ranges.x);
            var drawTo = d3.select(".wk-chart-axis.wk-chart-" + Position[_this._orient]);
            if (drawTo.empty()) {
              drawTo = ctnr.insert('g', '.wk-chart-layout-area').attr('class', "wk-chart-axis wk-chart-" + Position[_this._orient]);
            }
            if (animate) {
              drawTo.transition().duration(defaults_1.duration).call(_this._d3Axis);
            } else {
              drawTo.call(_this._d3Axis);
            }
            drawTo.selectAll('.tick > text').attr('transform', _this.getRotation(_this.tickRotation)).style('text-anchor', _this.getAnchor(_this._orient, _this.tickRotation)).attr('dy', _this.getDY(_this._orient, _this.tickRotation));
            var rotate = _this.getRotation(_this.tickRotation);
            var bgStyle = _this.tickLabelBgStyle;
            drawTo.selectAll('g.tick').each(function() {
              var bgRect = d3.select(this).select('rect');
              if (bgRect.empty()) {
                bgRect = d3.select(this).insert('rect', ':first-child');
              }
              bgRect.attr('transform', rotate).style(bgStyle);
              bgRect.attr(d3.select(this).select('text').node().getBBox());
            });
            drawTo.selectAll('path, line').style(_this.tickLineStyle);
            if (_this.title) {
              ...
              if (lRect.empty())
                lRect = labelG.append('rect');
              var lText = labelG.select('text');
              if (lText.empty())
                lText = labelG.append('text');
              lText.text(_this.title).style(_this.titleStyle).style('text-anchor', 'middle');
              switch (_this._orient) {
                case Position.left:
                case Position.right:
                case Position.top:
                  lText.attr('dy', '0.71em');
                  break;
                case Position.bottom:
                  lText.attr('dy', null);
              }
              lRect.attr(lText.node().getBBox());
              lRect.style(_this.titleBgStyle);
              var l = animate ? labelG.transition().duration(defaults_1.duration) : labelG;
              switch (_this._orient) {
                case Position.left:
                  l.attr('transform', "translate(" + -_this._requiredSpace + ", " + layoutSize.height / 2 + ") rotate(-90)");
                  break;
                case Position.right:
                  l.attr('transform', "translate(" + _this._requiredSpace + ", " + layoutSize.height / 2 + ") rotate(90)");
                  break;
                case Position.top:
                  l.attr('transform', "translate(" + layoutSize.width / 2 + ", " + -_this._requiredSpace + ")");
                  break;
                case Position.bottom:
                  l.attr('transform', "translate(" + layoutSize.width / 2 + ", " + _this._requiredSpace + ")");
                  break;
        ...
        Object.defineProperty(Axis.prototype, "titleStyle", {
          get: function() {
            return _.defaults(this._titleStyle, defaults_1.axis.titleStyle);
          },
          set: function(val) {
        ...
        ;
        Object.defineProperty(Axis.prototype, "titleBgStyle", {
          get: function() {
            return _.defaults(this._titleBgStyle, defaults_1.axis.titleBgStyle);
          },
          set: function(val) {
            this._titleBgStyle = val;
          },
          enumerable: true,
          configurable: true
        });
        ;
        Object.defineProperty(Axis.prototype, "tickLabelStyle", {
          get: function() {
            return _.defaults(this._tickLabelStyle, defaults_1.axis.tickLabelStyle);
          },
          set: function(val) {
            this._tickLabelStyle = val;
          },
          enumerable: true,
          configurable: true
        });
        ;
        Object.defineProperty(Axis.prototype, "tickLabelBgStyle", {
          get: function() {
            return _.defaults(this._tickLabelBgStyle, defaults_1.axis.tickLabelBgStyle);
          },
          set: function(val) {
            this._tickLabelBgStyle = val;
          },
          enumerable: true,
          configurable: true
        });
        ;
        Object.defineProperty(Axis.prototype, "tickLineStyle", {
          get: function() {
            return _.defaults(this._tickLineStyle, defaults_1.axis.tickLineStyle);
          },
          set: function(val) {
            this._tickLineStyle = val;
          },
          enumerable: true,
          configurable: true
        });
...
var __moduleName = "file:///app/baseLayouts/layout.ts";
System.register("app/baseLayouts/layout.ts", ["app/tools/array-diff.ts", "app/core/defaults.ts"], function(exports_1) {
  var array_diff_1,
      defaults_1;
  var Layout;
  return {
    setters: [function(_array_diff_1) {
      array_diff_1 = _array_diff_1;
    }, function(_defaults_1) {
      defaults_1 = _defaults_1;
    }],
    execute: function() {
      Layout = (function() {
        function Layout(valueScale, valueProperty, keyScale, keyProperty, colorScale, isVertical) {
          var _this = this;
          ...
          this._duration = defaults_1.duration;
          this.differ = array_diff_1.Diff({
            compress: false,
            unique: true
          });
          this._keyValues = [];
          ...
          this._values = {};
          this._prevValues = {};
          this.valFn = function(val) {
            return _this.valueScale.map(val[_this.valueProperty]);
          };
          this.valFnZero = function() {
            return _this.valueScale.map(0);
          };
          this.mapVal = function(val) {
            return _this.valueScale.map(val);
          };
          this.val = function(val) {
            return val[_this.valueProperty];
          };
          this.keyFn = function(val) {
            return _this.keyScale.map(val[_this.keyProperty]);
          };
          this.mapKey = function(val) {
            return _this.keyScale.map(val);
          };
          this.key = function(val) {
            return val[_this.keyProperty];
          };
          this.propertyColor = function() {
            if (_this.colorScale) {
              return _this.colorScale.map(_this.valueProperty);
            } else {
              return null;
            }
          };
          this.mapColor = function(val) {
            return _this.colorScale.map(val);
          };
          this.colorFn = function(val) {
            if (_this.colorScale) {
              return _this.colorScale.map(val[_this.keyProperty]);
            } else {
              return null;
            }
          };
          this.diffData = function(data) {
            _this._prevKeyValues = _this._keyValues;
            _this._prevValues = _this._values;
            _this._keyValues = [];
            _this._values = {};
            for (var _i = 0; _i < data.length; _i++) {
              var d = data[_i];
              _this._keyValues.push(_this.key(d));
              _this._values[_this.key(d)] = _this.val(d);
            }
            _this.diffSeq = _this.differ(_this._prevKeyValues, _this._keyValues);
          };
          this.startPos = function() {
            var range = _this.keyScale.getRange();
            var interv = range.length > 1 ? range[1] - range[0] : undefined;
            var seq = [];
            var rangeIdx = 0;
            var targetPos;
            for (var _i = 0,
                _a = _this.diffSeq; _i < _a.length; _i++) {
              var point = _a[_i];
              var op = point[0];
              var key = point[1];
              var val = _this._prevValues[key] || _this._values[key];
              seq.push({
                keyPos: rangeIdx < range.length ? range[rangeIdx] : range[range.length - 1] + interv,
                key: key,
                valPos: _this.mapVal(val),
                value: val,
                added: op === '+'
              });
              if (op !== '+')
          ...
          this.endPos = function() {
            ...
            for (var _i = 0,
              ...
              var op = point[0];
              var key = point[1];
              var val = _this._values[key] || _this._prevValues[key];
              seq.push({
                keyPos: rangeIdx < range.length ? range[rangeIdx] : range[range.length - 1] + interv,
                key: key,
                valPos: _this.mapVal(val),
          ...
          this.cleanPos = function(data) {
            ...
            for (var _i = 0; _i < data.length; _i++) {
              var point = data[_i];
              seq.push({
                keyPos: _this.keyFn(point),
                key: _this.key(point),
                valPos: _this.valFn(point),
                value: _this.val(point)
              });
            }
            return seq;
          };
          this.cleanSequence = function(data) {
            var seq = [];
            var pred = undefined;
            for (var _i = 0; _i < data.length; _i++) {
              var d = data[_i];
              seq.push({
                key: _this.key(d),
                value: _this.val(d),
                keyPos: _this.keyFn(d),
                valPos: _this.valFn(d)
              });
            }
            return seq;
          };
          this.targetContainer = 'wk-chart-layout-area';
          this.needsPadding = false;
          this.drawLayout = function(container, data, drawingAreaSize, animate, cbAnimationDone) {};
          this.beforeDraw = function(container, data, drawingAreaSize) {};
          this.afterDraw = function(container, data, drawingAreaSize) {};
          this.getPadding = function(container, data, drawingAreaSize) {
            var padding = {
              top: 0,
              bottom: 0,
              left: 0,
            ...
            _this.keyScale.setDomain(data);
            _this.keyScale.setRange(_this.isVertical ? [drawingAreaSize.height, 0] : [0, drawingAreaSize.width]);
            _this.valueScale.setDomain(data);
            _this.valueScale.setRange(_this.isVertical ? [0, drawingAreaSize.width] : [drawingAreaSize.height, 0]);
            var l = container.select(".wk-layout-" + _this._id + "-sizer");
            if (l.empty()) {
              l = container.append('g').attr('class', "wk-layout-" + _this._id + "-sizer");
            }
            var cleanData = _this.cleanPos(data);
            _this.beforeDraw(l, cleanData, drawingAreaSize);
            _this.drawLayout(l, cleanData, drawingAreaSize);
          ...
          this.drawStart = function(container, data, drawingAreaSize) {
            var l = container.select(".wk-layout-" + _this._id);
            if (l.empty()) {
              l = container.append('g').attr('class', "wk-layout-" + _this._id);
            }
            var startData = _this.startPos();
            _this.beforeDraw(l, startData, drawingAreaSize);
            _this.drawLayout(l, startData, drawingAreaSize, false);
            _this.afterDraw(l, startData, drawingAreaSize);
          };
          this.updateDomains = function(data) {
            _this.keyScale.setDomain(data);
            _this.valueScale.setDomain(data);
          };
          this.drawAnimation = function(container, data, drawingAreaSize) {
            var l = container.select(".wk-layout-" + _this._id);
            if (l.empty()) {
              l = container.append('g').attr('class', "wk-layout-" + _this._id);
            }
            var endData = _this.endPos();
            _this.beforeDraw(l, endData, drawingAreaSize);
            _this.drawLayout(l, endData, drawingAreaSize, true, function() {
              _this.drawEnd(container, data, drawingAreaSize);
            });
            _this.afterDraw(l, endData, drawingAreaSize);
          };
          this.drawEnd = function(container, data, drawingAreaSize) {
            var l = container.select(".wk-layout-" + _this._id);
            if (l.empty()) {
              l = container.append('g').attr('class', "wk-layout-" + _this._id);
            }
            ...
            _this.beforeDraw(l, cleanData, drawingAreaSize);
            _this.drawLayout(l, cleanData, drawingAreaSize);
            _this.afterDraw(l, cleanData, drawingAreaSize);
          };
          Layout.cnt += 1;
          this._id = Layout.cnt;
        }
        Layout.prototype.setupLayout = function() {};
        Layout.prototype.prepeareData = function(data) {
          this.diffData(data);
        };
        Layout.cnt = 0;
        return Layout;
...
var __moduleName = "file:///app/baseLayouts/xyElement.ts";
var __extends = (this && this.__extends) || function(d, b) {
  for (var p in b)
    if (b.hasOwnProperty(p))
      d[p] = b[p];
...
System.register("app/baseLayouts/xyElement.ts", ["app/baseLayouts/layout.ts", "npm:d3@3.5.6.js"], function(exports_1) {
  var layout_1,
      d3;
  var XYElement;
  return {
    ...
    execute: function() {
      XYElement = (function(_super) {
        __extends(XYElement, _super);
        function XYElement(valueScale, valueProperty, keyScale, keyProperty, colorScale, isVertical) {
          var _this = this;
          ...
          this.drawLayout = function(container, data, drawingAreaSize, animate, cbAnimationEnd) {
            var items = container.selectAll(_this.getSelector()).data(data, function(d) {
              return d.key;
            });
            var enter = items.enter().call(_this.create, _this);
            if (animate) {
              items.transition().duration(_this._duration).call(_this.update, _this).attr('transform', function(d) {
                return _this.getTranslate(d);
              }).call(_this.doFade, _this.fadeInOut).each('end', _this.removeDeleted);
              items.exit().transition().duration(_this._duration).call(_this.remove, _this).remove();
            } else {
              items.call(_this.update, _this).attr('transform', function(d) {
                return _this.getTranslate(d);
              }).call(_this.doFade, _this.fadeInOut);
              items.exit().call(_this.remove, _this).remove();
            }
          };
        }
        XYElement.prototype.getSelector = function() {
          return '';
        };
        XYElement.prototype.create = function(selection, caller) {};
        XYElement.prototype.update = function(selection, caller) {};
        XYElement.prototype.remove = function(selection, caller) {};
        XYElement.prototype.removeDeleted = function(d) {
          if (d.deleted) {
            d3.select(this).remove();
          }
        };
        XYElement.prototype.getTranslate = function(d) {
          if (this.isVertical) {
        ...
        XYElement.prototype.doFade = function(sel, fade) {
          if (fade)
            sel.style('opacity', function(d) {
              return d.added || d.deleted ? 0 : 1;
            });
        };
        return XYElement;
      })(layout_1.Layout);
      exports_1("XYElement", XYElement);
    }
  };
});
...
var __moduleName = "file:///app/core/scale.ts";
System.register("app/core/scale.ts", ["npm:d3@3.5.6.js", "npm:lodash@3.10.0.js"], function(exports_1) {
  var d3,
      _;
  var DomainCalc,
      Scale;
  return {
    ...
    execute: function() {
      (function(DomainCalc) {
        DomainCalc[DomainCalc["none"] = 0] = "none";
        DomainCalc[DomainCalc["min"] = 1] = "min";
        DomainCalc[DomainCalc["max"] = 2] = "max";
        DomainCalc[DomainCalc["extent"] = 3] = "extent";
        DomainCalc[DomainCalc["extentZero"] = 4] = "extentZero";
      })(DomainCalc || (DomainCalc = {}));
      exports_1("DomainCalc", DomainCalc);
      Scale = (function() {
        function Scale(type, properties, domainRange) {
          var _this = this;
          if (domainRange === void 0) {
            domainRange = DomainCalc.none;
          }
          this.properties = properties;
          this.domainRange = domainRange;
          this.isInverted = false;
          this.getD3Scale = function() {
            return _this._d3Scale;
          };
          this.getTicks = function() {
            return _this.isOrdinal ? _this._d3Scale.domain() : _this._d3Scale.ticks();
          };
          this.setRange = function(range) {
            var invertedRange = [range[1], range[0]];
            if (_this.isOrdinal) {
              _this._d3Scale.rangeBands(_this.isInverted ? invertedRange : range);
            } else {
              _this._d3Scale.range(_this.isInverted ? invertedRange : range);
            }
          };
          this.getRange = function() {
            return _this._d3Scale.range();
          };
          this.getRangeBand = function() {
            return _this.isOrdinal ? _this._d3Scale.rangeBand() : 0;
          };
          this.setDomain = function(data) {
            if (_this.domainRange === DomainCalc.none) {
              if (_this.properties.length === 1) {
                _this._d3Scale.domain(_.pluck(data, _this.properties[0]));
              }
            } else {
              var min = Infinity;
              var max = -Infinity;
              for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < _this.properties.length; j++) {
                  var v = data[i][_this.properties[j]];
                  if (v > max)
                    max = v;
                  if (v < min)
                    min = v;
              ...
              switch (_this.domainRange) {
                case DomainCalc.extent:
                  _this._d3Scale.domain([min, max]);
                  break;
                case DomainCalc.min:
                  _this._d3Scale.domain([0, min]);
                  break;
                case DomainCalc.max:
                  _this._d3Scale.domain([0, max]);
                  break;
                case DomainCalc.extentZero:
                  _this._d3Scale.domain(min * max > 0 ? (min < 0 ? [min, 0] : [0, max]) : [min, max]);
              }
            }
          };
          this.getDomain = function() {
            return _this._d3Scale.domain();
          };
          this.map = function(value) {
            return _this._d3Scale(value);
          };
          this.mapZero = function() {
            return _this._d3Scale(0);
          };
          this.type = type;
        }
        ...
        Object.defineProperty(Scale.prototype, "isOrdinal", {
          get: function() {
...
System.register("app/core/chart.ts", ["app/core/scale.ts", "app/core/axis.ts", "app/core/grid.ts", "npm:d3@3.5.6.js", "npm:lodash@3.10.0.js", "app/tools/drawing.ts", "app/tools/resizeSensor.ts", "app/core/defaults.ts", "app/tools/innerSVG.ts"], function(exports_1) {
  ...
  return {
    setters: [function(_scale_1) {
      ...
      drawing = _drawing;
    }, function(_resizeSensor_1) {
      resizeSensor_1 = _resizeSensor_1;
    }, function(_defaults_1) {
      defaults_1 = _defaults_1;
    }, function(_) {}],
    execute: function() {
      Chart = (function() {
        function Chart(drawInto, title, subTitle) {
          var _this = this;
          this.title = title;
          ...
          this._drawingAreaSize = {
            width: 0,
            height: 0
          };
          this._dataLabelSpace = {
            top: 0,
            left: 0
          };
          this._ranges = {
          ...
          this._titleBgStyle = {};
          this._subTitleStyle = {};
          this._subTitleBgStyle = {};
          this._titleHeight = 0;
          this._subTitleHeight = 0;
          this.scales = [];
          this.axis = [];
          this.layouts = [];
          this.grids = [];
          this.d3Sel = function(selector) {
            return _this._d3Container.select(selector);
          };
          this.measureTitles = function() {
            _this._titleHeight = drawing.measureLabel(_this.title, _this.d3Sel('.wk-chart-title'), _this.titleStyle, _this.titleBgStyle).height;
            _this._subTitleHeight = drawing.measureLabel(_this.subTitle, _this.d3Sel('.wk-chart-subtitle'), _this.subTitleStyle, _this.subTitleBgStyle).height;
            _this._layoutMargins.top = _this._titleHeight + _this._subTitleHeight;
          };
          this.drawTitles = function() {
            var title = _this.d3Sel('.wk-chart-title').style({
              display: 'block',
              'pointer-events': 'none'
            }).attr('transform', "translate(" + _this._containerSize.width / 2 + "," + (_this._titleHeight - defaults_1.chart.margins.top) + ")");
            title.select('text').style(_this.titleStyle);
            title.select('rect').style(_this.titleBgStyle).attr(title.select('text').node().getBBox());
            var subTitle = _this.d3Sel('.wk-chart-subtitle').style({
              display: 'block',
              'pointer-events': 'none'
            }).attr('transform', "translate(" + _this._containerSize.width / 2 + "," + (_this._titleHeight + _this._subTitleHeight - defaults_1.chart.margins.top) + ")");
            subTitle.select('text').style(_this.subTitleStyle);
            subTitle.select('rect').style(_this.subTitleBgStyle).attr(subTitle.select('text').node().getBBox());
          };
          this.measureAxis = function() {
            for (var _i = 0,
                _a = _this.axis; _i < _a.length; _i++) {
              var axis = _a[_i];
              _this._layoutMargins[axis_1.Position[axis.orientation]] += axis.getNeededSpace(_this.d3Sel('.wk-chart-container'), _this.data);
            }
          };
          this.drawAxis = function(animate) {
            _this.axis.forEach(function(axis) {
              axis.draw(_this.d3Sel('.wk-chart-container'), _this.data, _this._drawingAreaSize, _this._ranges, animate);
            });
          };
          this.drawGrids = function(animate) {
            _this.grids.forEach(function(grid) {
              grid.draw(_this.d3Sel('.wk-chart-container'), _this._ranges, animate);
            });
          };
          this.sizeLayoutArea = function() {
            _this._drawingAreaSize.height = _this._containerSize.height - _this._layoutMargins.top - _this._layoutMargins.bottom;
            _this._drawingAreaSize.width = _this._containerSize.width - _this._layoutMargins.left - _this._layoutMargins.right;
          };
          this.positionLayout = function(animate) {
            var cntr = _this.d3Sel('.wk-chart-container');
            if (animate) {
              console.log('animated Position');
              cntr.transition().duration(defaults_1.duration).attr('transform', "translate(" + _this._layoutMargins.left + ", " + _this._layoutMargins.top + ")");
              _this._d3Container.selectAll('.wk-chart-bottom').transition().duration(defaults_1.duration).attr('transform', "translate(0," + _this._drawingAreaSize.height + ")");
              _this._d3Container.selectAll('.wk-chart-right').transition().duration(defaults_1.duration).attr('transform', "translate(" + _this._drawingAreaSize.width + ")");
            } else {
              cntr.attr('transform', "translate(" + _this._layoutMargins.left + ", " + _this._layoutMargins.top + ")");
              _this._d3Container.selectAll('.wk-chart-bottom').attr('transform', "translate(0," + _this._drawingAreaSize.height + ")");
              _this._d3Container.selectAll('.wk-chart-right').attr('transform', "translate(" + _this._drawingAreaSize.width + ")");
            }
          };
          this.prepeareData = function() {
            _this.layouts.forEach(function(layout) {
              layout.prepeareData(_this.data);
            });
          };
          this.setupLayouts = function() {
            _this.layouts.forEach(function(layout) {
              layout.setupLayout();
            });
          };
          this.drawAnimation = function() {
            _this.layouts.forEach(function(layout) {
              layout.drawAnimation(_this.d3Sel("." + layout.targetContainer), _this.data, _this._drawingAreaSize);
            });
          };
          this.drawStartLayouts = function() {
            _this.layouts.forEach(function(layout) {
              layout.drawStart(_this.d3Sel("." + layout.targetContainer), _this.data, _this._drawingAreaSize);
            });
          };
          this.drawEndLayouts = function() {
            _this.layouts.forEach(function(layout) {
              layout.drawEnd(_this.d3Sel("." + layout.targetContainer), _this.data, _this._drawingAreaSize);
            });
          };
          this.updateDomains = function() {
            _this.layouts.forEach(function(layout) {
              layout.updateDomains(_this.data);
            });
          };
          this.getLayoutPadding = function() {
            _this._layoutPadding = {
              top: 0,
              bottom: 0,
              left: 0,
              right: 0
            ...
            for (var _i = 0,
                _a = _this.layouts; _i < _a.length; _i++) {
              var layout = _a[_i];
              if (layout.needsPadding) {
                var padding = layout.getPadding(_this.d3Sel("." + layout.targetContainer), _this.data, _this._drawingAreaSize);
                _this._layoutPadding.top = Math.max(padding.top, _this._layoutPadding.top);
                _this._layoutPadding.bottom = Math.max(padding.bottom, _this._layoutPadding.bottom);
                _this._layoutPadding.left = Math.max(padding.left, _this._layoutPadding.left);
                _this._layoutPadding.right = Math.max(padding.right, _this._layoutPadding.right);
              }
            }
          };
          this.sizeRange = function() {
            _this._ranges.x = [_this._layoutPadding.left, _this._drawingAreaSize.width - _this._layoutPadding.right];
            _this._ranges.y = [_this._drawingAreaSize.height - _this._layoutPadding.bottom, _this._layoutPadding.top];
          };
          this.addScale = function(type, properties, domainCalc) {
            var s = new scale_1.Scale(type, properties, domainCalc);
            _this.scales.push(s);
            return s;
          };
          this.addAxis = function(orientation, scale, title) {
            var a = new axis_1.Axis(orientation, scale, title);
            _this.axis.push(a);
            return a;
          };
          this.addGrid = function(axis) {
            var g = new grid_1.Grid(axis);
            _this.grids.push(g);
            return g;
          };
          ...
          this.draw = function(data) {
            if (data) {
              ...
              _this._newData = false;
            }
            console.log("draw called");
            _this.setupLayouts();
            _this.prepeareData();
            if (_this._newData && !_this._initialDraw) {
              _this.drawStartLayouts();
            }
            _this._containerSize = _this._d3Container.select('.wk-chart-svg').node().getBoundingClientRect();
            _this._layoutMargins = _.assign(_this._layoutMargins, defaults_1.chart.margins);
            _this.measureTitles();
            _this.measureAxis();
            _this.sizeLayoutArea();
            _this.drawTitles();
            _this.updateDomains();
            _this.sizeRange();
            if (_this._initialDraw || !_this._newData) {
              console.log('initial draw');
              _this.positionLayout(false);
              _this.getLayoutPadding();
              _this.sizeRange();
              _this.drawAxis(false);
              _this.drawGrids(false);
              _this.drawEndLayouts();
            } else {
              _this.positionLayout(true);
              _this.getLayoutPadding();
              _this.sizeRange();
              _this.drawAxis(true);
              _this.positionLayout(true);
              _this.drawGrids(true);
              _this.drawAnimation();
              console.log('animated draw');
            }
            _this._initialDraw = false;
          };
          Chart._id += 1;
          ...
          new resizeSensor_1.ResizeSensor(this._container.querySelector(".wk-chart"), this.draw);
        }
        Object.defineProperty(Chart.prototype, "titleStyle", {
          get: function() {
            return _.defaults(this._titleStyle, defaults_1.chart.titleStyle);
          },
          set: function(val) {
            this._titleStyle = val;
          },
        ...
        ;
        Object.defineProperty(Chart.prototype, "subTitleStyle", {
          get: function() {
            return _.defaults(this._subTitleStyle, defaults_1.chart.subTitleStyle);
          },
          set: function(val) {
        ...
        ;
        Object.defineProperty(Chart.prototype, "titleBgStyle", {
          get: function() {
            return _.defaults(this._titleBgStyle, defaults_1.chart.titleBgStyle);
          },
          set: function(val) {
            this._titleBgStyle = val;
          },
        ...
        ;
        Object.defineProperty(Chart.prototype, "subTitleBgStyle", {
          get: function() {
            return _.defaults(this._subTitleBgStyle, defaults_1.chart.subTitleBgStyle);
          },
          set: function(val) {
            this._subTitleBgStyle = val;
          },
          enumerable: true,
          configurable: true
        });
...
System.register("app/app.ts", ["app/core/chart.ts", "app/core/scale.ts", "app/core/axis.ts", "app/layouts/column.ts", "app/decorators/dataLabels.ts", "app/tools/data-table.ts"], function(exports_1) {
  ...
  function main(el) {
    ...
    var y2Scale = chart.addScale('linear', ['y2'], scale_1.DomainCalc.extent);
    ...
    var axisTop = chart.addAxis(axis_1.Position.top, y2Scale, 'X - Scale Top');
    var axisLeft = chart.addAxis(axis_1.Position.left, yScale, 'Y - Scale');
    var axisRight = chart.addAxis(axis_1.Position.right, x2Scale, 'Y - Axis Right');
    ...
    chart.draw(data);
    new data_table_1.DataTable('#data-table', data, function(data) {
      chart.draw(data);
    });
    function rotationHandler(ev) {
      var r = Number(ev.target.value);
    ...
    document.getElementById('rotation').addEventListener('change', function(ev) {
      rotationHandler(ev);
    });
